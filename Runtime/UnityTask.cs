...
namespace U.Universal.Tasks
{
    public static partial class UnityTask
    {
        ...
        public static Task WaitForSeconds(float seconds) => WaitForSeconds(TaskRunner.Instance.InDontDestroyonLoad, seconds);
        public static Task WaitForSecondsRealtime(float seconds) => WaitForSecondsRealtime(TaskRunner.Instance.InDontDestroyonLoad, seconds);
        public static Task WaitForEndOfFrame() => WaitForEndOfFrame(TaskRunner.Instance.InDontDestroyonLoad);
        public static Task WaitForFixedUpdate() => WaitForFixedUpdate(TaskRunner.Instance.InDontDestroyonLoad);
        public static Task WaitUntil(Func<bool> predicate) => WaitUntil(TaskRunner.Instance.InDontDestroyonLoad, predicate);
        public static Task WaitWhile(Func<bool> predicate) => WaitWhile(TaskRunner.Instance.InDontDestroyonLoad, predicate);
